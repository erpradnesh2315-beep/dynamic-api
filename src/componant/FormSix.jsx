...
const FormSix = () => {
    ...
    const formsubmit = async(e) => {
        ...
        if(editid){
            ...
            const respform = await axios.post("https://6a1cf58fbcc4f20d5ca3bbde.mockapi.io/blogpost");
            setposts([...posts, respform.data]);
            // Clear Result
            title.current.value = "";
    ...
    const deletedata = async(id) => {
        try {
        axios.delete(`https://6a1cf58fbcc4f20d5ca3bbde.mockapi.io/blogpost/${id}`);
  ...
  return <>
    <form onSubmit={formsubmit}>
        ...
        <input type="submit" value={editid !== null ? "Update" : "Add Post"} />
    </form>
